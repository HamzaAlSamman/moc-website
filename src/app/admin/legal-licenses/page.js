...
export default async function LegalLicensesAdminPage() {
  ...
  return <div className="space-y-6" dir="rtl"><header><p className="text-xs font-black uppercase tracking-widest text-[#b9a779]">مديرية الشؤون القانونية</p><h1 className="mt-1 text-2xl font-black text-[#054239]">طلبات التراخيص القانونية</h1><p className="mt-1 text-sm text-slate-500">البحث والتصفية والطباعة ومتابعة سير الاعتماد دون حذف نهائي.</p></header><LegalLicenseTable items={items} /></div>;
}
