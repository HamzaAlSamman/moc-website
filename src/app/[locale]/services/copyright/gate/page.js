...
const T = {
  ar: {
    ...
    desc: "خدمة حقوق المؤلف والملكية الفكرية قيد التجربة الداخلية حالياً ولم تُطلق للعامة بعد. يرجى إدخال كلمة السر المؤقتة للدخول.",
    label: "كلمة السر",
  ...
  en: {
    ...
    desc: "The Copyright & Intellectual Property service is under internal testing and not yet public. Please enter the temporary password to continue.",
    label: "Password",
...
export default function CopyrightGatePage(props) {
  ...
  const next = searchParams.get("next") || `/${locale}/services/copyright`;
