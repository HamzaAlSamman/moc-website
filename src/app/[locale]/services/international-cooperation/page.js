...
const T = {
  ar: {
    ...
    responseNote: "المدة المتوقعة للرد على رسالتك تتراوح بين يومين وأسبوع عمل.",
    ...
    messagePlaceholder: "اكتب تفاصيل رسالتك بشكل واضح...",
    ...
    successSubtitle: "وصلت رسالتك إلى مديرية التعاون الدولي وستتم مراجعتها والرد عليها في أقرب وقت.",
    ...
    nextStepsList: [
      ...
      "سيتم التواصل معك عبر البريد الإلكتروني أو رقم الهاتف الذي أدخلته.",
    ],
