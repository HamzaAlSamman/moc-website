...
const T = {
  ar: {
    ...
    audienceNote: "هذه الخدمة متاحة لجميع المواطنين والمؤسسات دون اشتراط صفة معينة للتقديم.",
    responseNote: "تبدأ معالجة الشكوى في غضون 3 أيام عمل.",
    anonymityNote: "تتيح الخدمة تقديم الشكوى دون الكشف عن هوية مقدمها أو طلب معلومات شخصية.",
    ...
    anonymousToggleHint: "عند تفعيل هذا الخيار، لن يتطلب تقديم الشكوى إدخال أي بيانات شخصية أو معلومات تواصل.",
    anonymousActiveNote: "تقديم الشكوى دون الكشف عن الهوية يحول دون إمكانية التواصل معكم أو إعلامكم بنتيجة المراجعة.",
    ...
    messagePlaceholder: "يرجى كتابة تفاصيل الشكوى بدقة ووضوح...",
    imagesLabel: "صور أو مستندات داعمة",
    imagesHint: "اختياري — يمكن إرفاق وثائق أو صور تدعم الشكوى (بحد أقصى 5 ملفات، 5 ميجابايت لكل ملف).",
    ...
    successTitle: "تم تقديم الشكوى بنجاح",
    successSubtitle: "تم استلام الشكوى وستقوم مديرية الرقابة الداخلية بمراجعتها والتدقيق فيها أصولاً.",
    referenceLabel: "الرقم المتسلسل للشكوى",
    referenceHint: "يرجى الاحتفاظ بهذا الرقم كونه المرجع الوحيد لمتابعة الشكوى لاحقاً.",
    nextStepsTitle: "ماذا بعد؟",
    nextStepsList: [
      "تتم مراجعة الشكوى من قبل مديرية الرقابة الداخلية في وزارة الثقافة.",
      "تبدأ معالجة الشكوى في غضون 3 أيام عمل.",
      "سيتم التواصل معكم لإعلامكم بنتيجة المراجعة في حال تزويدنا ببيانات تواصل صحيحة.",
    ],
  ...
  en: {
    ...
    responseNote: "Complaint processing begins within 3 working days.",
    ...
    nextStepsList: [
      ...
      "Complaint processing begins within 3 working days.",
