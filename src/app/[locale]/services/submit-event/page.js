...
const T = {
  ar: {
    ...
    subtitle: "بوابة إلكترونية مخصصة للجهات العامة والأهلية والأفراد لتقديم طلبات إقامة الفعاليات الثقافية وإضافتها للروزنامة بعد التدقيق والاعتماد.",
    ...
    termsNote: "لا يعد تقديم هذا الطلب بمثابة موافقة نهائية على إقامة الفعالية؛ حيث يتم إشعار الجهة المقترحة بالموافقة الرسمية عبر كتاب رسمي صادر عن الوزارة.",
    ...
    pledgeTextAfterName: "، أقر بالاطلاع والموافقة على كافة الضوابط والمعايير الخاصة بتنفيذ الفعاليات الثقافية الصادرة عن وزارة الثقافة السورية، وأتعهد بالالتزام التام ببنودها وتحمل المسؤولية القانونية الكاملة عن التنفيذ وفقاً للمواصفات المعتمدة.",
    backToTerms: "← العودة لمراجعة الشروط",
    submitButton: "تقديم الطلب الرسمي",
    submittingText: "جاري إرسال الطلب...",
    successTitle: "تم إرسال طلبك بنجاح",
    successSubtitle: "تم استلام طلب إقامة الفعالية بنجاح. ستقوم مديرية إدارة الفعاليات والمهرجانات بمراجعة الطلب والتواصل معكم في أقرب وقت ممكن.",
    nextStepsTitle: "ما الذي يحدث الآن؟",
    nextStepsList: [
      "سيتم الرد من قِبل مديرية إدارة الفعاليات والمهرجانات خلال المدة المحددة.",
      "سيتم دراسة طلبك وفق معايير وزارة الثقافة.",
      "سيتم التواصل معكم لاستكمال الإجراءات القانونية والتنظيمية في حال الموافقة المبدئية.",
    ],
...
export default function SubmitEventPage(props) {
  ...
  // كل انتقال بين خطوات المعالج يعيد الصفحة إلى أعلاها.
